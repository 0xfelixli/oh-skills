...
| API credentials | Follow guided setup in Step 2, or set in `skills/post-to-wechat/.env` |
...
**API selected + missing credentials** → run guided setup per `references/api-setup.md` (writes to the skill-local `.env`).
